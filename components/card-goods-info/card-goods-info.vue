...
<template>
  <view class="card-goods-item" @click="routerTo('/pages/shop/goods?id=')">
    <view class="card-left">
      <image class="img" :src="cardData._bannerImg" mode="aspectFill"></image>
    </view>
    <view class="card-right">
      <view class="top-box">
        <view class="title"> 标题 标题 标题{{ info.name }}</view>
      </view>
    </view>
    ...
    <view class="bottom-box">
      ...
      <view class="item"><text class="iconfont icon-comment-filling" /> </view>
    </view>
  </view>
</template>
