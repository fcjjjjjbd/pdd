  ...
  <view class="content-container" @click="handleContentClick">
    ...
    <view class="left-wrap">
      ...
      <view class="interaction-bar">
        ...
        <!-- 点赞 -->
        <view class="interaction-item">
          <uni-icons :type="item.isLiked ? 'heart-filled' : 'heart'" size="25"
            :color="item.isLiked ? '#ff4757' : '#666'"></uni-icons>
        ...
        <!-- 收藏 -->
        <view class="interaction-item">
          <uni-icons :type="item.isCollected ? 'star-filled' : 'star'" size="25"
            :color="item.isCollected ? '#ffa502' : '#666'"></uni-icons>
