...
<template>
	<view class="uni-content">
		...
		<uni-list>
			  <uni-list-item showArrow title="APPID" clickable :rightText="userInfo._id" @click="clickID(userInfo._id)" >
  </uni-list-item>
			<uni-list-item class="item" @click="" title="账号" :rightText="userInfo.username||'未设置'" >
			</uni-list-item>
